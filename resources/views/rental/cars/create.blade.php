    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card form-card">
                ...
                <div class="card-body">
                    <form action="{{ route('rental.cars.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('car_type') is-invalid @enderror" 
                                        ...
                                        <option value="Crossover" {{ old('car_type') == 'Crossover' ? 'selected' : '' }}>Crossover</option>
                                        ...
                                        <option value="Other" {{ old('car_type') == 'Other' ? 'selected' : '' }}>Khác</option>
                                    </select>
                                    @error('car_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('color') is-invalid @enderror" 
                                        ...
                                        <option value="Xanh" {{ old('color') == 'Xanh' ? 'selected' : '' }}>Xanh</option>
                                        ...
                                        <option value="Other" {{ old('color') == 'Other' ? 'selected' : '' }}>Khác</option>
                                    </select>
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Mô tả chi tiết về xe, tính năng, tình trạng...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
