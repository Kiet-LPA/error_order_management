                                ...
                                <div class="attachment-list">
                                    ...
                                    <div class="attachment-item" data-attachment-id="{{ $attachment->id }}">
                                        ...
                                        <div class="attachment-thumbnail video-thumbnail-container" 
                                            ...
                                            data-video-url="{{ route('comment.attachments.view', $attachment) }}"
                                            ...
                                            <source src="{{ route('comment.attachments.view', $attachment) }}" type="video/mp4">
                                            <source src="{{ route('comment.attachments.view', $attachment) }}" type="video/avi">
                                            <source src="{{ route('comment.attachments.view', $attachment) }}" type="video/mov">
                                            <source src="{{ route('comment.attachments.view', $attachment) }}" type="video/webm">
                                            </video>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <video controls class="w-100" style="max-height: 70vh;" onerror="showVideoError(this)">
                                ...
                                <div class="alert alert-warning">
                                    ...
                                    <a href="${videoUrl.replace('/view', '/download')}" target="_blank" class="btn btn-sm btn-primary ms-2">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="${videoUrl.replace('/view', '/download')}" target="_blank" class="btn btn-primary">
    ...
    function showVideoError(videoElement) {
        console.log('Video load error:', videoElement);
        // Error handling is already in the HTML fallback
    }

    // Add event listeners for video thumbnails
    document.addEventListener('DOMContentLoaded', function() {
        // Add click listeners to video thumbnail containers
